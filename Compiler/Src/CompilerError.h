...
namespace BFC
{
	struct CompilerError
	{
		enum Code : u32
		{
			...
			ARGS_OS         = ARGS | 0b0110,
			ARGS_OS_UNKN    = ARGS | 0b0111,

			ARGS_NO_TGT         = ARGS | 0b1000,
			ARGS_MAIN_TGT       = ARGS | 0b1001,
			ARGS_MAIN_FOLDER    = ARGS | 0b1010,
			ARGS_OUT_FOLDER     = ARGS | 0b1011,
			ARGS_INTER_FILE     = ARGS | 0b1100,
			ARGS_TGT_NOT_EXISTS = ARGS | 0b1101,
		};
